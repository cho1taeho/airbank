...
fun GroupConfirmScreen( navController: NavController
    ...
    val group_id: Int = com.airbank.myapplication.AirbankApplication.prefs.getString("tempid","0").toInt()
    LaunchedEffect(Unit){
    ...
    Column(
        ...
        if(com.airbank.myapplication.AirbankApplication.prefs.getString("tempid","").isNotEmpty()){
            Row(){
                Button(
                    onClick = {
                        ...
                        val group_id = com.airbank.myapplication.AirbankApplication.prefs.getString("group_id","").toInt()
                        if (group_id != 0){
    ...
    fun handlesubmit(navController: NavController,patchGroupsConfirmRequest: PATCHGroupsConfirmRequest, group_id: Int){
        ...
        viewModelScope.launch(Dispatchers.IO) {
            ...
            if(response.isSuccessful){
                ...
                com.airbank.myapplication.AirbankApplication.prefs.setString("tempid","")
