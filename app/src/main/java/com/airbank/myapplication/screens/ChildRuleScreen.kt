    ...
    Column(
        ...
        Button(
            onClick = {
                ...
                val groupid = com.airbank.myapplication.AirbankApplication.prefs.getString("group_id", "0").toInt()
        ...
        viewModelScope.launch(Dispatchers.IO) {
            ...
            if(postresponsedata == null){
                ...
                if(patchresponsedata != null) { //PATCH
                    com.airbank.myapplication.AirbankApplication.prefs.setString("allowanceAmount",patchresponsedata.data.allowanceAmount.toString())
                    com.airbank.myapplication.AirbankApplication.prefs.setString("allowanceDate",patchresponsedata.data.allowanceDate.toString())
                    com.airbank.myapplication.AirbankApplication.prefs.setString("taxRate",patchresponsedata.data.taxRate.toString())
                    com.airbank.myapplication.AirbankApplication.prefs.setString("confiscationRate",patchresponsedata.data.confiscationRate.toString())
                    com.airbank.myapplication.AirbankApplication.prefs.setString("loanLimit",patchresponsedata.data.loanLimit.toString())
                }else{
