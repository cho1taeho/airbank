package com.airbank.myapplication.network

import com.airbank.myapplication.AirbankApplication
import com.airbank.myapplication.api.HDApiService
...
//    private const val BASE_URL = "http://192.168.35.202:8080/"
    ...
    class AppInterceptor : Interceptor {
        ...
        override fun intercept(chain: Interceptor.Chain)
                : Response = with(chain) {
            val JSESSIONID = com.airbank.myapplication.AirbankApplication.prefs.getString("JSESSIONID","")
